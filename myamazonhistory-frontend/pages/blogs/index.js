...
const Blogs = ({ blogs, categories, tags, totalBlogs, blogsLimit, blogSkip, router }) => {
    const head = () => (
        <Head>
            <title>Favorite Amazon Product | {APP_NAME}</title>
            <meta
                name="description"
                content="Check out our community's Favorite Products - which they actually purchased on Amazon!"
            />
            <link rel="canonical" href={`${DOMAIN}${router.pathname}`} />
            <meta property="og:title" content={`Our Community's Favorite Amazon Products | ${APP_NAME}`} />
            <meta
                property="og:description"
                content="Build an Amazon site within minutes - populated with products you've already purchased on Amazon!"
            />
                        ...
                        <header>
                            <div className="col-md-12 pt-3">
                                <h1 className="display-4 font-weight-bold text-center">
                                    Explore the Community's Favorite Amazon Products
                                </h1>
                            </div>
